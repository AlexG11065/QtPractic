...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        self.lineEditLogin.setPlaceholderText(
            "Введите логин")  # добавьте placeholderText "Введите логин" с помощью метода .setPlaceholderText()
        ...
        layoutLogin = QtWidgets.QVBoxLayout()  # Создайте QHBoxLayout
        ...
        layoutPassword = QtWidgets.QVBoxLayout()  # Создайте QHBoxLayout
        ...
        layoutButtons = QtWidgets.QVBoxLayout()  # Создайте QHBoxLayout
        layoutButtons.addWidget(self.pushButtonLogin)  # с помощью метода .addWidget() добавьте self.pushButtonLogin
        layoutButtons.addWidget(
            self.pushButtonRegistration)  # с помощью метода .addWidget() добавьте self.pushButtonRegistration
